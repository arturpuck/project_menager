...
class CreateOrEditProjectRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'work_stages.*' => ['required', 'exists:task_stages,id'],
            ...
            'work_stage_date_start.*' => ['required', 'date'],
            'work_stage_dead_line_date.*' => ['required', 'date'],
            'payment_stage_names.*' => ['required', 'max:30'],
            'payment_ammounts.*' => ['required', 'min:0', 'numeric'],
            'payment_stage_dates.*' => ['required', 'date'],
    ...
    public function messages(){
        ...
        return [
            ...
            'work_stage_date_start.date' => 'at_least_one_work_stage_date_start_has_incorrect_format',
            'work_stage_dead_line_date.required' => 'work_stage_dead_line_date_is_missing',
            'work_stage_dead_line_date.date' => 'at_least_one_work_stage_dead_line_date_has_incorrect_format',
            ...
            'payment_stage_dates.date' => 'payment_stage_date_has_incorrect_format',
            ...
            'finish_date.date' => 'finish_date_has_incorrect_format',
